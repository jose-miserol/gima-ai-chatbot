      ...
      : [
          {
            ...
            value: [
              ...
              // "connect-src 'self' blob: https://api.groq.com https://generativelanguage.googleapis.com https://analytics.example.com",
              "connect-src 'self' blob: https://api.groq.com https://generativelanguage.googleapis.com",
              "media-src 'self' blob:",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
